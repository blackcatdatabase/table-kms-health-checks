...
final class KmsHealthChecksModule implements ModuleInterface
{
    public function name(): string { return 'table-kms_health_checks'; }
    public function table(): string { return 'kms_health_checks'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-kms_keys', 'table-kms_providers' ]; }

    public static function contractView(): string { return 'vw_kms_health_checks'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_kms_hc_key_time', 'idx_kms_hc_provider_time' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_kms_hc_key', 'fk_kms_hc_provider' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_kms_hc_key_time', 'idx_kms_hc_provider_time' ],
            'foreignKeys' => [ 'fk_kms_hc_key', 'fk_kms_hc_provider' ],
        ];
    }
}
