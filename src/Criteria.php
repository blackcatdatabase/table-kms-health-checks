...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'provider_id', 'kms_key_id', 'status', 'latency_ms', 'error', 'checked_at' ];
    }
    ...
    {
        $x = [ 'id', 'provider_id', 'kms_key_id', 'status', 'latency_ms', 'error', 'checked_at' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'kms_providers' => 'j0', 'kms_keys' => 'j1' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\KmsHealthChecks\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\KmsHealthChecks\Definitions::softDeleteColumn();
