...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'kms_health_checks'; }
    public static function contractView(): string { return 'vw_kms_health_checks'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'provider_id', 'kms_key_id', 'status', 'latency_ms', 'error', 'checked_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'provider_id', 'kms_key_id', 'latency_ms' ]; }
