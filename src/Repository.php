...
use BlackCat\Database\Packages\KmsHealthChecks\Repository\KmsHealthCheckRepository;
...
{
    private KmsHealthCheckRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KmsHealthCheckRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KmsHealthChecks\Dto\KmsHealthCheckDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KmsHealthChecks\Dto\KmsHealthCheckDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KmsHealthChecks\Dto\KmsHealthCheckDto|null
    {
