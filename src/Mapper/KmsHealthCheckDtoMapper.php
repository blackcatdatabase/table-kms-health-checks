...
namespace BlackCat\Database\Packages\KmsHealthChecks\Mapper;

use BlackCat\Database\Packages\KmsHealthChecks\Dto\KmsHealthCheckDto;
use BlackCat\Database\Packages\KmsHealthChecks\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO KmsHealthCheckDto:
...
final class KmsHealthCheckDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'provider_id', 'kms_key_id', 'latency_ms' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'checked_at' ];
    /** @var string[] */
     ...
     * @return KmsHealthCheckDto
     */
    public static function fromRow(array $row): KmsHealthCheckDto
    {
        /** @var KmsHealthCheckDto */
        return DtoHydrator::fromRow(
            KmsHealthCheckDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?KmsHealthCheckDto
    {
     ...
     *
     * @param KmsHealthCheckDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(KmsHealthCheckDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KmsHealthCheckDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KmsHealthCheckDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KmsHealthCheckDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KmsHealthCheckDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KmsHealthCheckDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KmsHealthCheckDto>
     */
