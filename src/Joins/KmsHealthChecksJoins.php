...
namespace BlackCat\Database\Packages\KmsHealthChecks\Joins;
 ...
 */
final class KmsHealthChecksJoins {
    ...
    /**
     * FK: kms_health_checks -> kms_providers
