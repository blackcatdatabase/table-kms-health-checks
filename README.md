...
> Lineage: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 2 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\kms-health-checks](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\kms-health-checks) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package kms-health-checks -Apply
